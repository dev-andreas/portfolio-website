<template>
  <ul class="flex flex-col gap-5 relative">
    ...
    <li v-for="item, index in props.items" class="flex items-center" :key="item.title">
      ...
      <div class="bgg p-3 rounded-lg w-64 sm:w-96 lg:w-64 xl:w-96 pr-8" 
